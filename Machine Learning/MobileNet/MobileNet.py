...
from LoadImagesMobileNet import *

# importare model MobileNet_v2, impreuna cu weight-urile potrivite
# modificarea ultimului layer
model = models.mobilenet_v2(MobileNet_V2_Weights.DEFAULT)
model.classifier = nn.Sequential(
    torch.nn.Dropout(0.2),
    torch.nn.Linear(model.classifier[1].in_features, 25)
)
